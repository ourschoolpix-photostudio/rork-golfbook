-- Fix event_payments table to use TEXT instead of UUID for foreign keys
-- This matches the actual types in events and members tables
...
CREATE INDEX idx_event_payments_member_id ON event_payments(member_id);
CREATE INDEX idx_event_payments_created_at ON event_payments(created_at DESC);
