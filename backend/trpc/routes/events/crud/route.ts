...
const eventSchema = z.object({
  ...
  day1StartType: z.enum(['tee-time', 'shotgun']).optional().nullable(),
  ...
  day2StartType: z.enum(['tee-time', 'shotgun']).optional().nullable(),
  ...
  day3StartType: z.enum(['tee-time', 'shotgun']).optional().nullable(),
