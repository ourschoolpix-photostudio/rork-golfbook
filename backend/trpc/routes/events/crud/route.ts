...
const eventSchema = z.object({
  ...
  package1Price: z.string().optional().nullable(),
  package1Description: z.string().optional().nullable(),
  package2Name: z.string().optional().nullable(),
  package2Price: z.string().optional().nullable(),
  package2Description: z.string().optional().nullable(),
  package3Name: z.string().optional().nullable(),
  package3Price: z.string().optional().nullable(),
  package3Description: z.string().optional().nullable(),
  ...
  day1CourseId: z.string().optional().nullable(),
  day1TeeBox: z.enum(['tips', 'men', 'lady']).optional().nullable(),
  ...
  day2CourseId: z.string().optional().nullable(),
  day2TeeBox: z.enum(['tips', 'men', 'lady']).optional().nullable(),
  ...
  day3CourseId: z.string().optional().nullable(),
  day3TeeBox: z.enum(['tips', 'men', 'lady']).optional().nullable(),
