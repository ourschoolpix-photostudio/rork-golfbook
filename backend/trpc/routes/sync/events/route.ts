...
const eventSchema = z.object({
  ...
  type: z.enum(['tournament', 'social']).optional(),
  photoUrl: z.string().optional(),
  entryFee: z.string().optional(),
  numberOfDays: z.union([z.literal(1), z.literal(2), z.literal(3)]).optional(),
  address: z.string().optional(),
  city: z.string().optional(),
  state: z.string().optional(),
  zipcode: z.string().optional(),
  day1StartTime: z.string().optional(),
  day1StartPeriod: z.enum(['AM', 'PM']).optional(),
  day1Course: z.string().optional(),
  day1StartType: z.enum(['tee-time', 'shotgun']).optional(),
  day1LeadingHole: z.string().optional(),
  day1Par: z.string().optional(),
  day1HolePars: z.array(z.string()).optional(),
  day2StartTime: z.string().optional(),
  day2StartPeriod: z.enum(['AM', 'PM']).optional(),
  day2Course: z.string().optional(),
  day2StartType: z.enum(['tee-time', 'shotgun']).optional(),
  day2LeadingHole: z.string().optional(),
  day2Par: z.string().optional(),
  day2HolePars: z.array(z.string()).optional(),
  day3StartTime: z.string().optional(),
  day3StartPeriod: z.enum(['AM', 'PM']).optional(),
  day3Course: z.string().optional(),
  day3StartType: z.enum(['tee-time', 'shotgun']).optional(),
  day3LeadingHole: z.string().optional(),
  day3Par: z.string().optional(),
  day3HolePars: z.array(z.string()).optional(),
  flightACutoff: z.string().optional(),
  flightBCutoff: z.string().optional(),
  flightATeebox: z.string().optional(),
  flightBTeebox: z.string().optional(),
  flightLTeebox: z.string().optional(),
  registeredPlayers: z.array(z.string()).optional(),
});
